<template>
    <div class="flex flex-col md:max-w-md space-y-4 p-3 text-[17px] text-gray-600 dark:text-gray-300 leading-relaxed border bordr-gray-700 darK:border-gray-800 rounded-xl">
        ...
        <div class="flex justify-between w-full space-x-3">
            <a href="#" class="flex items-center justify-center w-full py-2 space-x-6 text-gray-200 bg-black rounded-xl">
                <!--Dark mode-->
                <svg viewBox="0 0 496 512" fill="#fff" class="hidden w-10 h-10 dark:flex" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="#" class="flex items-center justify-center w-full py-2 space-x-6 text-gray-200 bg-blue-600 rounded-xl">
                <span>Behance</span>
            </a>
        </div>
    </div>
