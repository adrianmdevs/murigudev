<template>
    <div class="flex flex-col md:max-w-md space-y-4 p-3 text-gray-600 text-[13px] md:text-[15px] dark:text-gray-300 leading-relaxed border border-gray-400 dark:border-gray-600 rounded-xl">
        ...
        <div class="flex flex-col text-gray-500 dark:text-gray-400 text-[15px] md:text-[17px] space-y-3 leading-relaxed">
            <p>
        ...
        <div class="flex justify-between w-full space-x-3">
            <a href="https://github.com/murigugitonga" class="flex py-2.5 items-center justify-center w-full space-x-6 text-gray-500 dark:text-gray-200 bg-white border border-black dark:border-[#fefefe] dark:bg-[#333535] rounded-xl">
                <!--Dark mode-->
            ...
            <a href="https://www.behance.net/murigugitonga" class="flex py-2.5 items-center justify-center w-full space-x-6 text-gray-800 dark:bg-[#fefefe] bg-white border dark:text-gray-300 border-black rounded-xl">
                ...
                <span class="font-semibold text-black">Behance</span>
            </a>
        </div>
    </div>
</template>