...
<template>
    <header class="w-full px-6 py-4 bg-gray-200 border-b shadow-sm border-gray-500/20 dark:border-gray-500/50 md:rounded-lg z-99 max-sm:px-3 dark:bg-black md:border-gray-300">
